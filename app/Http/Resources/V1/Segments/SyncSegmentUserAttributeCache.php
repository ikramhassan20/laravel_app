...
class SyncSegmentUserAttributeCache implements ProcessItemDataContract
{
    ...
    {
        $this->itemCacheKey = "company_{$this->companyId}_appgroup_".$params['app_group_id']."_segment_".$params['segment_id']."_rows";
    }
}
