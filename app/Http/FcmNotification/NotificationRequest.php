...
class NotificationRequest extends BaseRequest
{
     ...
     */
    public function __construct($to, Options $options = null, PayloadNotificationDataBinding $notification = null, PayloadData $data = null, Topics $topic = null, $server_key)
    {
        parent::__construct();
