        ...
        <div class="d_table">
            <div class="v_middle">
                <div class="unsubscribe_holder">
                    <form name="frm" action="{{ route('unsubscribe-user') }}?enc={{ $data['track_key']  }}" method="post">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <h1>{{ $data['company_name'] }}</h1>
                        <img src="/images/mail-box-ico.svg" alt="#" class="mail_icon">
                        <h2>You’ve unsubscribe</h2>
                        <p class="">You’re about to unsubscribe !</p>
                        <p class="bordered">Are you sure you want to unsubscribe?</p>
                        <div class="un_btns">
                            <a href="#" id="btn_confirm_yes" class="btn_confirm">Confirm</a>
                            <!--a href="#" id="btn_confirm_no" class="btn_confirm inactive">No</a-->
                        </div>
                    </form>
                </div>
            </div>
